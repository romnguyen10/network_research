...
- ngoài ra cò sử dụng trong thông tin liên lạc như: mail, voiIP, thương mại điện tử.

<a name="home"></a>
#### 1.2 Nhà ứng dụng:
- Nhà chứa nhiều các thiết bị mạng. Ví dụ: máy tính, TV, kết nối với Internet bằng cáp, DSL, không dây,...
- Trang chủ người sử dụng giao tiếp. Ví dụ như các trang mạng xã hội: zalo, facebook, viber,...; các giao dịch như mua bán, đấu giá,...
...
- Người dùng sử di động trong giao tiếp, xem video,giải trí, truy cập Web và sử dụng để định vị-GPS,...
...
- Trung lập mạng - không hạn chế mạng
- Quyền sở hữu nội dung, chỉ gỡ xuống theo DMCA (DMCA là chữ viết tắt của Digital Millennium Copyright Act hay chúng ta thường gọi là Luật bảo vệ bản quyền tác giả).
...
<a name="neutrality"></a>
#### 1.5. Mạng trug lập:
- Net neutrality là hình thức tự do internet, rất bình đẳng, với mục tiêu giúp người sử dụng truy cập mạng không bị các nhà cung cấp dịch vụ (ISP) mạng làm khó.
- Nếu không có Net neutrality, khách muốn truy cập thông tin với vận tốc nhanh phải trả thêm tiền cho ISP để các ISP tăng tốc độ cho chúng ta.
...
- Mạng Pan là mạng cá nhân được sử dụng trong phạm vi nhỏ hẹp, 1 người 
- Pan có dây phổ biến nhất là USB. Ngoài ra không dây công nghệ mạng là Bluetooth,...
...
- Có thể là mạng doanh nghiệp trong một công ty
...
- Kết nối các thiết bị trong khu vực, trong nước,...Ví dụ WAN kết nối ba văn phòng chi nhánh
